...
constexpr u32 kSioMulti0 = 0x04000120;
...
constexpr u32 kJoyStat = 0x04000158;
constexpr u32 kMgbaLogStringLo = 0x04FFF600;
constexpr u32 kMgbaLogStringHi = 0x04FFF700;
constexpr u32 kMgbaLogSend = 0x04FFF700;
constexpr u32 kMgbaLogEnable = 0x04FFF780;
